...
public class RecipientRegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backToLogin = findViewById(R.id.recipientAlreadyRegistered);
        backToLogin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(RecipientRegisterActivity.this,LoginActivity.class);
                startActivity(i);
            }
        });
        ...
        registerReceiver = findViewById(R.id.registerReciever);
        ...
        registerReceiver.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (bloodGroup.equals("Select your blood group")){
                    Toast.makeText(RecipientRegisterActivity.this, "Select blood group", Toast.LENGTH_SHORT).show();
                }
                if (resultUri == null){
                    Toast.makeText(RecipientRegisterActivity.this, "You must select and image", Toast.LENGTH_SHORT).show();
                }
                    ...
                    loader.setMessage("Registering Recipient...");
                                ...
                                userDatabaseReference.updateChildren(userInfo).
                                        addOnCompleteListener(new OnCompleteListener() {
                                            ...
                                            public void onComplete(@NonNull Task task) {
                                                if (task.isSuccessful()){
                                                    Toast.makeText(RecipientRegisterActivity.this,
                                                            "Recipient Registered Successfully", Toast.LENGTH_SHORT).show();
                                                }else {
                                                    Toast.makeText(RecipientRegisterActivity.this,
                                                ...
                                                result.addOnSuccessListener(new OnSuccessListener<Uri>() {
                                                    ...
                                                    public void onSuccess(Uri uri) {
                                                        ...
                                                        userDatabaseReference.updateChildren(newIMageMp).addOnCompleteListener(new OnCompleteListener() {
                                                            ...
                                                            public void onComplete(@NonNull Task task) {
                                                                if (task.isSuccessful()){
                                                                    Toast.makeText(RecipientRegisterActivity.this, "Image uploaded " +
